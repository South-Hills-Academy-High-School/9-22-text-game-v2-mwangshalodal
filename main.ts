...
function 魔 () {
    ...
    mySprite3 = sprites.create(img`
        ...
        ....f8f....f......f...fff.ffff..
        `, SpriteKind.Player)
    game.showLongText("汝为苏铭", DialogLayout.Bottom)
}
function startstory () {
    scene.setBackgroundImage(img`
    ...
    story.showPlayerChoices("drink Ice Tea", "walk 10 mils")
...
function drink_Ice_Tea () {
    game.showLongText("you drink ice tea, and dinersor came gives you power", DialogLayout.Bottom)
